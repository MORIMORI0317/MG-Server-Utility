...
public class flat {
	...
	public static void onRenderLivingPre(RenderLivingEvent.Pre<EntityLivingBase> event) {
		...
		if (entity.dimension == MGConfig.OOD_ID && !(entity instanceof EntityPlayerSP)) {
			...
			try {
				float f = 0;
				float f1 = renderer.interpolateRotation(entity.prevRotationYawHead, entity.rotationYawHead,
						partialTicks);
				float f2 = f1 - f;

				if (shouldSit && entity.getRidingEntity() instanceof EntityLivingBase) {
					EntityLivingBase entitylivingbase = (EntityLivingBase) entity.getRidingEntity();
					f = renderer.interpolateRotation(entitylivingbase.prevRenderYawOffset,
			...
			net.minecraftforge.common.MinecraftForge.EVENT_BUS
					.post(new net.minecraftforge.client.event.RenderLivingEvent.Post<EntityLivingBase>(entity, renderer,
							partialTicks, x, y, z));
		}
	}
