...
public class MODItems {
	...
	public static Item IKISUGITHI_TOTEM = new Item()
			.setRegistryName(MGServerUtility.MODID, "ikisuginithi_totem")
			.setUnlocalizedName("ikisuginithi_totem").setMaxStackSize(1);
	...
	public static Item ENDUREEMPTINESS_RECORD = new IItemRecord("endureemptiness", MGSoundEvents.ENDUREEMPTINESS)
			.setRegistryName(MGServerUtility.MODID, "endureemptiness_record")
			.setUnlocalizedName("record")/*MGTAB*/;

	public static Item FIGHTFORQUIESCENCE_RECORD = new IItemRecord("fightforquiescence",
			MGSoundEvents.FIGHTFORQUIESCENCE)
					.setRegistryName(MGServerUtility.MODID, "fightforquiescence_record")
					.setUnlocalizedName("record")/*MGTAB*/;

	public static Item HARUNOKOE_RECORD = new IItemRecord("harunokoe", MGSoundEvents.HARUNOKOE)
			.setRegistryName(MGServerUtility.MODID, "harunokoe_record")
			.setUnlocalizedName("record")/*MGTAB*/;

	public static Item HUKIGENNAKAZITU_RECORD = new IItemRecord("hukigennakazitu", MGSoundEvents.HUKIGENNAKAZITU)
			.setRegistryName(MGServerUtility.MODID, "hukigennakazitu_record")
			.setUnlocalizedName("record")/*MGTAB*/;

	public static Item HUNNYOURESUTORAN_RECORD = new IItemRecord("hunnyouresutoran",
			MGSoundEvents.HUNNYOURESUTORAN)
					.setRegistryName(MGServerUtility.MODID, "hunnyouresutoran_record")
					.setUnlocalizedName("record")/*MGTAB*/;
	...
	public static Item APPLE_OF_DARKNESS = new ItemAppleD(2, 1, false)
			.setRegistryName(MGServerUtility.MODID, "apple_of_darkness")
			.setUnlocalizedName("apple_of_darkness");
	...
	public static List<Item> registerItemList() {
		...
		l.addAll(Arrays.asList(
				...
				AWAKENING_RECORD,
				KEIZOKU_HIGH_RECORD,
				ENDUREEMPTINESS_RECORD,
				FIGHTFORQUIESCENCE_RECORD,
				HARUNOKOE_RECORD,
				HUKIGENNAKAZITU_RECORD,
				HUNNYOURESUTORAN_RECORD,
				BLADE_LOTTERY_BAG,
				HEAD_LOTTERY_BAG,
				GUN_LOTTERY_BAG,
				ITEM_LOTTERY_BAG,
	...
	public static List<Item> hideItemList() {
		...
		l.addAll(Arrays.asList(
				...
				HUNNYOURESUTORAN_RECORD,
				IKISUGITHI_TOTEM,
				Item.getItemFromBlock(MODBlocks.TEST_BLOCK),
				APPLE_OF_DARKNESS
